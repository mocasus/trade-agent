...
from trade_agent.models import Action, Candle, Decision, Indicators, MarketContext, Ticker
...
def _ctx(price=100.0):
    ...
    return MarketContext(symbol="BTC", timeframe="1h", candles=candles,
                         ticker=_ticker(price), indicators=Indicators())
