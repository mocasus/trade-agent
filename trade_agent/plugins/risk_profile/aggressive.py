"""Aggressive risk profile plugin."""
...
class AggressiveProfile(RiskProfileInterface):
    def __init__(self):
        self.max_pct = 15.0
        self.min_pct = 2.0
        self.confidence_floor = 55
        self.stop_loss_pct = 3.5
        self.atr_multiplier = 2.0
        self.rr_ratio = 1.5
        self.max_loss_pct = 10.0
        self.max_positions = 8
        self.reserve_pct = 5.0
...
def register():
    return {"name": "aggressive", "class": AggressiveProfile, "description": "Aggressive risk profile"}
